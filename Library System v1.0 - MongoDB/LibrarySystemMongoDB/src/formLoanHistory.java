...
public class formLoanHistory extends javax.swing.JFrame {
    ...
    private void btnShowHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowHistoryActionPerformed
        ...
        String inputCustNum = txtStudentNumber.getText();
        ...
        FindIterable<Document> resultHistory = dao.getLoanHistory(inputCustNum, inputFromDate, inputToDate);
        MongoCursor<Document> cursorResult = resultHistory.iterator();
        ...
        while(cursorResult.hasNext()){
            ...
            List<Document> listRtrnBooks = (List<Document>) doc.get("Returned_Books");
            ...
            int index2 = 0;
                        if(listRtrnBooks != null){
                            for (Document book : listRtrnBooks) {
                                   Document bookObj = dao.getBook(book.getString("Book_ISBN"));
                                   rtrnBooksToTbl[index2] = bookObj.getString("Book_Name");
                                   index2 = index2 + 1;
                            }      
                        }
