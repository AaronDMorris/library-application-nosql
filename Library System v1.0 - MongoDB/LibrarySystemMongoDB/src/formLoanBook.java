...
public class formLoanBook extends javax.swing.JFrame {
    ...
    private void btnAddBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddBookActionPerformed
        ...
        Document book = dao_loanRecord.getBook(txtISBN.getText());
        
        //Adding data into GUI table
        DefaultTableModel tbl_model_books = (DefaultTableModel) tblBooks.getModel();
        tbl_model_books.addRow(new Object[]{book.get("Book_ISBN"), book.get("Book_Name")});
    ...
    private void btnCreateLoanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateLoanActionPerformed
        ...
        Document loan = new Document() 
            ...
            .append("Student_Num", student.get("Student_Num")) 
            .append("First_Name", student.get("First_Name")) 
            .append("Last_Name", student.get("Last_Name")) 
            .append("Addr_Line1", student.get("Addr_Line1"))
            .append("City", student.get("City"))
            .append("Postcode", student.get("Postcode"))
